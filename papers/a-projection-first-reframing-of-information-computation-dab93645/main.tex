...
\title{A Projection-First Reframing of Information, Computation, and Undecidability}
\author{Peter Nero}
\date{January 2026}
...
\maketitle
\section*{Preface: Scope and Role of This Paper in the Projection-First Series}
...
\section{Why Information Became Fundamental}
...
\begin{itemize}
\item distinctions are coarse-grained,
\item many states are identified as equivalent,
\item reconstruction is impossible,
\item and irreversible compression has occurred.
\end{itemize}
...
\clearpage
\section{Information as Description, Not Substance}
...
Information is not a substance. It is a measure of \emph{distinguishability within a description}.
...
\clearpage
\section{Computation as Predictive Description}
...
Computability is not a property of underlying dynamics alone. It is a property of \emph{effective description}.
...
\clearpage
\section{Undecidability as Structural, Not Epistemic}
...
Undecidability is therefore not a defect of formalism. It is a \emph{consistency requirement}.
...
\clearpage
\section{Information Loss Reframed}
...
\begin{itemize}
\item during measurement, when coupling to additional degrees of freedom collapses distinguishability,
\item under thermalization, when fine-grained correlations overwhelm descriptive capacity,
\item at horizons, where global reconstruction becomes impossible,
\item and in complex interacting systems, where prediction exhausts admissibility margins.
\end{itemize}
