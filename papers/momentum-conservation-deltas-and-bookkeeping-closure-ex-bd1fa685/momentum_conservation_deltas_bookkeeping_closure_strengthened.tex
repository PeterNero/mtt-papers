...
\usepackage{series}
\hypersetup{
  pdftitle={Momentum Conservation Deltas and Bookkeeping Closure},
  pdfauthor={Peter Nero},
  pdfcreator={LaTeX}
}

\title{Momentum Conservation Deltas and Bookkeeping Closure\\
\large Exact Vertex Conservation as the Singular Limit of Finite Admissible Interaction Support}
\author{Peter Nero}
\date{April 2026}
