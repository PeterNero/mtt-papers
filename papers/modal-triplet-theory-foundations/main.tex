...
or a restatement of the fixed-point gates. It is a continuum intertwiner from
the local strain carrier to the physical q79 HYM complex that preserves the
connection, Hessian, and normalized response data. With that map and a
