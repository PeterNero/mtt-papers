...
The result does not yet determine the numerical value of \(\tau\) in nature. It does something more basic and necessary: it shows that once an MTT fixed-point sector supplies \(\tau\) and the operator data, the finite correction is specific.
